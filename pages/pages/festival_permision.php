		...
		<div  class="container card"><br>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<form action="javascript:void(0);" id="festival_permission_form" method="POST">
...
?>
					...
					<br>
					<div class="">
					<input style="width: 80%;height: 35px;padding-left: 20px;border:1px solid gray;border-radius: 5px;" type="text" class="name" name="name" placeholder="Applicant Name">
				</div>	
				...
				<div class="">
						<select style="width: 80%;height: 35px;padding-left: 20px;border-radius: 5px;" class="permission_for" name="permission_for">
							<option>Permission For:</option>

							<option>Ganesh festival </option>
							<option>Navratri festival</option>
						</select>
					</div>
					<br>
				...
				<div class="">
					<input style="width: 80%;height: 35px;padding-left: 20px;border:1px solid gray;border-radius: 5px;" type="text" class="address" name="address" placeholder="Address">
				</div>	

				<br>

				<div class="">
					<input style="width: 80%;height: 35px;padding-left: 20px;border:1px solid gray;border-radius: 5px;" type="text" class="permission_date" name="permission_date" placeholder="permission date">
				</div>

				<br>

				<div class="">
					<input style="width: 80%;height: 35px;padding-left: 20px;border:1px solid gray;border-radius: 5px;" type="text" class="description" name="description" placeholder="Description">
				</div>
 ...
 <script type="text/javascript">
 	$(document).ready(function(){
 		...
 		// })
 				 ...
 				 $('#festival_permission_form').submit(function(event){
  event.preventDefault();


    $.ajax({
     url:"../php/create_festival_permission.php",
     method:"POST",
